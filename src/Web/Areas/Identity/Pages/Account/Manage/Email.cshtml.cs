    ...
    public partial class EmailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (Input.NewEmail != email)
            {
                ...
                StatusMessage = "Ссылка для подтверждения изменения отправленно по почте. Пожалуйста, проверьте свою электронную почту.";
        ...
        public async Task<IActionResult> OnPostSendVerificationEmailAsync()
        {
            ...
            StatusMessage = "Отправлено электронное письмо с подтверждением. Пожалуйста, проверьте свою электронную почту.";
            return RedirectToPage();
        }
    }
}
